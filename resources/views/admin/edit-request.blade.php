          ...
          <div class="card-body checkout-form">
            ...
            <div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <input class="form-control mb-3" type="text" id="firstnameeditar" name="firstnamear" value="{{ $requests->bachlor_student_first_name_ar }}">
                </div>
                <div class="form-group">
                    <input class="form-control mb-3" type="text" id="lastnameeditar" name="lastnamear" value="{{ $requests->bachlor_student_last_name_ar }}">
                </div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-select mb-3" id="faculty" name="faculty" aria-label="faculty">
                        <option value="{{ $requests->faculty_id }}" selected>{{ $requests->faculty_code }}</option>
...
{{--                        @endforeach--}}
                ...
                <div class="form-group">
                    <select class="form-select mb-3 domain_bb" id="domain" name="domain" aria-label="domain">
                        <option value="{{ $requests->domain_id }}" selected>{{ $requests->domain_code }}</option>
                    </select>
                </div>
                Filiére:
                <div class="form-group">
                    <select class="form-select mb-3 devision_bb" id="devision" name="devision" aria-label="devision">
                        <option value="{{ $requests->division_id }}" selected>{{ $requests->division_code }}</option>
                    </select>
                </div>
                Specialité:
                <div class="form-group">
                    <select class="form-select mb-3 speciality_bb" id="speciality" name="speciality" aria-label="speciality">
                        <option value="{{ $requests->division_id }}" selected>{{ $requests->speciality_code }}</option>
                    </select>
                </div>
